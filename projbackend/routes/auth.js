...
import { signout,signup,signin,isSignedIn, isAuthenticated, isAdmin } from "../controllers/auth.js";
...
authRoutes.get("/testroute",isSignedIn,isAuthenticated,isAdmin,(req,res) => {
